...
const Chat = () => {
  ...
  const fetchDocDetails = async () => {
    try {
      ...
      const res = await axios.get(`https://smartlearn-ai-backend-20cp.onrender.com/api/document/${docId}`, {
  ...
  const handleSend = async (e) => {
    ...
    try {
      const token = JSON.parse(localStorage.getItem('user'))?.token;
      const res = await axios.post('https://smartlearn-ai-backend-20cp.onrender.com/api/chat', 
