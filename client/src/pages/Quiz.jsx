...
const Quiz = () => {
  ...
  const generateQuiz = async () => {
    ...
    try {
      ...
      const res = await axios.post('https://smartlearn-ai-backend-20cp.onrender.com/api/quiz/generate', 
  ...
  const submitFinalScore = async () => {
    try {
      ...
      await axios.post('https://smartlearn-ai-backend-20cp.onrender.com/api/quiz/submit', 
